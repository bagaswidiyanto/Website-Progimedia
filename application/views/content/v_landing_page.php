...
<div class="services-area-home" id="services-area-home">
    ...
    <div class="packaging many-menus">
        <img src="<?= base_url(); ?>assets/images/landing-page/background-landing-page.png" class="img-fluid bground"
            alt="">
        ...
        <div class="container many-menus-container">
            <div class="row">
                <div class="col-xl-8 col-lg-9 col-md-11 col-sm-10" data-aos="fade-up" data-aos-duration="2000">
                    <div class="section-text">
                        <div class="title">
                            <h1>LANDING PAGE</h1>
                            <!-- <h4>Mengapa logo sangat penting bagi pemasar?</h4> -->
                        </div>
                        <p><?= $landing_page->title; ?></p>
                        <div class="desk mt-5">
                            <?= $landing_page->deskripsi; ?>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="landing-page">
    <img class="img-fluid bg-people" src="<?= base_url(); ?>assets/images/landing-page/background-people.png" alt="">
    <div class="container">
                ...
                <div class="list-content">
                    <div class="content  d-flex align-items-center" data-aos="fade-up" data-aos-duration="2000">
                        <img class="img-fluid"
                            ...
                            alt="">
                        <div class="text-cnt">
                            <h5><?= $konten->header_1; ?></h5>
                            <p><?= $konten->content_1; ?></p>
                        </div>
                    </div>
                    <div class="content d-flex align-items-center mt-4" data-aos="fade-up" data-aos-duration="2000">
                        <img class="img-fluid"
                            src="<?= base_url(); ?>assets/images/brand-identity/desain-katalog-produk/check-g.png"
                            alt="">
                        <div class="text-cnt">
                            <h5><?= $konten->header_2; ?></h5>
                            <p><?= $konten->content_2; ?></p>
                        </div>
                    </div>
                    <div class="content  d-flex align-items-center mt-4" data-aos="fade-up" data-aos-duration="2000">
                        <img class="img-fluid"
                            ...
                            alt="">
                        <div class="text-cnt">
                            <h5><?= $konten->header_3; ?></h5>
                            <p><?= $konten->content_3; ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="package-choice">
    ...
    <div class="container container-package">
        <div class="section-text-middle text-center" data-aos="fade-up" data-aos-duration="2000">
            ...
            <h2 class="mb-5">Pricelist Landing Page</h2>
        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 content-pricelist" data-aos="fade-up"
                    ...
                    <div class="card card-pricelist">
                        ...
                        <div class="card-body check">
                            ...
                            <div class="mx-auto">
                                <a href="https://wa.wizard.id/13bc51" target="_blank">INFO LEBIH LANJUT</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="call-me">
    ...
    <div class="container call-me-container">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-5 col-md-5 col-sm-6 col-6" data-aos="fade-right" data-aos-delay="200">
                <div class="box-col" style="background: #377AB7;">
                    <img class="img-fluid" src="<?= base_url(); ?>assets/images/produk-packaging/icon-phone.png" alt="">
                    <p>(+62) <?= $telp; ?></p>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-6 col-6" data-aos="fade-left" data-aos-delay="200">
                <div class="box-col" style="background: #48B737;">
                    <img class="img-fluid" src="<?= base_url(); ?>assets/images/produk-packaging/icon-wa.png" alt="">
                    <a href="<?= $waLink; ?>" target="_blank" class="text-white">
                        <p><?= $wa; ?></p>
                    </a>
                </div>
            </div>
